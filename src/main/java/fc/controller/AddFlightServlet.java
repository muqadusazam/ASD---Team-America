...
public class AddFlightServlet extends HttpServlet{
    ...
    throws ServletException, IOException {
        ...
        HttpSession session = request.getSession(); //Gets the current http session
           ...
           String airline = request.getParameter("airline");
            ...
            if (!validate(numPattern,price)){ 
            errors.put("AvaSeatError", "The number of seats should be a number");
        }
    ...
    private String timePattern = "[0-2][0-3][:][0-5][0-9] [ap]m";
    private String datePattern = "((19|2[0-9])[0-9]{2})-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])";
