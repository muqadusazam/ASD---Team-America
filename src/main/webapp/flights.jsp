    ...
    <div class="container" style="margin-top: 50px">
        ...
        <form action="FlightsSearchServlet" method="GET">
             <!-- Dropdown box for Origins-->
                Find a flight from&nbsp;<select name ="searchOrigin" id="searchOrigin" >                    
                ...
                &nbsp;to&nbsp;<input type="text" name="searchDestination" id ="searchDestination" placeholder="Anywhere">
                         
                <!-- Date box for Arrival Date-->
                &nbsp;by&nbsp;<input type="date" name ="searchArrivalDate" id ="searchArrivalDate">       
